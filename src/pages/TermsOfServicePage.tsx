...
import { FileText, Scale, CreditCard, AlertTriangle, Users, Shield } from 'lucide-react'
        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
              Ao acessar e usar o Adsmart, você concorda com estes Termos de Uso. 
              Se não concordar com qualquer parte destes termos, não use nosso serviço. 
              O Adsmart é um serviço de automação de relatórios para campanhas do Google Ads e Meta Ads.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3 text-gray-600 dark:text-gray-400">
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mt-4">
                <p className="text-sm">
                  <strong>Importante:</strong> O CPF cadastrado não pode ser alterado após o primeiro uso, 
                  por questões de segurança e conformidade fiscal.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3 text-gray-600 dark:text-gray-400">
              ...
              <h3 className="font-medium text-gray-900 dark:text-white mt-4">Formas de Pagamento</h3>
              <ul className="list-disc list-inside space-y-1">
                <li>PIX (processado via SuitPay)</li>
                <li>Cartão de crédito (em breve)</li>
              </ul>

              <h3 className="font-medium text-gray-900 dark:text-white mt-4">Política de Reembolso</h3>
              <p>
                Reembolsos podem ser solicitados em até 7 dias após a compra, 
                desde que os créditos não tenham sido utilizados.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Todo o conteúdo, design, código e tecnologia do Adsmart são propriedade 
              da Zenny Tecnologia ou licenciados para uso. É proibida a cópia, 
