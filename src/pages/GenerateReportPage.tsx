      ...
      <MainLayout>
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <Button onClick={() => navigate('/templates')}>Voltar aos Templates</Button>
          </div>
        </div>
      </MainLayout>
    )
            ...
            <>
              ...
              <Card className="mb-6">
                <CardHeader>
                  ...
                  <CardDescription>Selecione a conta que deseja analisar</CardDescription>
                </CardHeader>
                <CardContent>
                  {accounts.length === 0 ? (
                    <div className="text-center py-4">
                      <p className="text-gray-500 dark:text-gray-400 mb-4">
                        Nenhuma conta{' '}
                        {template.platform === 'google_ads' ? 'Google Ads' : 'Meta Ads'} conectada
                      </p>
                      <Button onClick={() => navigate('/accounts')}>Conectar Conta</Button>
                    </div>
                  ) : (
                    <select
                          ...
                          >
                            <Checkbox
                              ...
                              onCheckedChange={(checked) =>
                                handleCampaignToggle(campaign.campaignId, checked)
                              }
                            />
                            <label
                ...
                <Card className="mb-6 border-yellow-200 bg-yellow-50 dark:bg-yellow-900/20">
                  <CardContent className="pt-6">
                    <p className="text-yellow-800 dark:text-yellow-200 text-sm">
                      Para fins de demonstração, você pode continuar sem conectar uma conta. Na
                      versão final, será necessário conectar sua conta de anúncios.
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              <Card className="mb-6">
                <CardHeader>
                  ...
                  <CardDescription>Defina o período dos dados do relatório</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Button
                ...
                onClick={() => setStep(2)}
                disabled={
                  accounts.length > 0 && (!selectedAccount || selectedCampaigns.length === 0)
                }
              >
            ...
            <>
              ...
              <Card className="mb-6">
                <CardHeader>
                  ...
                  <CardDescription>Escolha como deseja pagar pelo relatório</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    <div
                      className={`p-4 border rounded-lg ${hasBalance ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 opacity-50'}`}
                    >
                      <div className="flex items-center justify-between">
