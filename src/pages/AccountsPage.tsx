...
const MetaAdsIcon = () => (
  <svg width="24" height="24" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="meta-gradient-accounts" x1="5.3" x2="506.8" y1="255.9" y2="255.9" gradientUnits="userSpaceOnUse">
                    ...
                    {loading ? (
                      ...
                      <div className="space-y-3">
                        {googleAccounts.map((account) => (
                          <div key={account.id} className="flex items-center justify-between p-3 bg-white dark:bg-gray-700 rounded-lg gap-2">
                            <div className="min-w-0 flex-1">
