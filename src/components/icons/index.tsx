...
export const TemplatesIcon = ({ className, size = 24, color = 'currentColor' }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      d="M6.48828 2H5.59766C4.16531 2 3 3.16531 3 4.59766V18.4023C3 19.8347 4.16531 21 5.59766 21H6.48828C7.92063 21 9.08594 19.8347 9.08594 18.4023V4.59766C9.08594 3.16531 7.92063 2 6.48828 2ZM7.60156 18.4023C7.60156 19.0162 7.10214 19.5156 6.48828 19.5156H5.59766C4.98379 19.5156 4.48438 19.0162 4.48438 18.4023V4.59766C4.48438 3.98379 4.98379 3.48438 5.59766 3.48438H6.48828C7.10214 3.48438 7.60156 3.98379 7.60156 4.59766V18.4023Z"
      fill={color}
    />
    <path
      d="M19.4023 2H13.2422C11.8098 2 10.6445 3.16531 10.6445 4.59766V5.48828C10.6445 6.92063 11.8098 8.08594 13.2422 8.08594H19.4023C20.8347 8.08594 22 6.92063 22 5.48828V4.59766C22 3.16531 20.8347 2 19.4023 2ZM20.5156 5.48828C20.5156 6.10214 20.0162 6.60156 19.4023 6.60156H13.2422C12.6283 6.60156 12.1289 6.10214 12.1289 5.48828V4.59766C12.1289 3.98379 12.6283 3.48438 13.2422 3.48438H19.4023C20.0162 3.48438 20.5156 3.98379 20.5156 4.59766V5.48828Z"
      fill={color}
    />
    <path
      d="M19.4023 9.68164H13.2422C11.8098 9.68164 10.6445 10.8469 10.6445 12.2793V18.4023C10.6445 19.8347 11.8098 21 13.2422 21H19.4023C20.8347 21 22 19.8347 22 18.4023C22 17.9924 21.6677 17.6602 21.2578 17.6602C20.8479 17.6602 20.5156 17.9924 20.5156 18.4023C20.5156 19.0162 20.0162 19.5156 19.4023 19.5156H13.2422C12.6283 19.5156 12.1289 19.0162 12.1289 18.4023V12.2793C12.1289 11.6654 12.6283 11.166 13.2422 11.166H19.4023C20.0162 11.166 20.5156 11.6654 20.5156 12.2793V14.6914C20.5156 15.1013 20.8479 15.4336 21.2578 15.4336C21.6677 15.4336 22 15.1013 22 14.6914V12.2793C22 10.8469 20.8347 9.68164 19.4023 9.68164Z"
      fill={color}
    />
  </svg>
)
