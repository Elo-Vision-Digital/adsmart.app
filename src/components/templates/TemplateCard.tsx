...
export function TemplateCard({
  ...
  return (
    <Card
      className={`overflow-hidden transition-all duration-200 cursor-pointer w-full ${
        theme === 'dark'
    ...
    >
      <div className="relative h-40 md:h-48 bg-gradient-to-b from-transparent to-black/50">
        ...
        <div
          className={`absolute top-2 right-2 md:top-4 md:right-4 px-3 py-1.5 md:px-4 md:py-2 rounded-lg flex items-center gap-2 ${
      ...
      <CardHeader className="pb-4 px-4 md:px-6">
        <CardTitle
          className={`text-base md:text-lg ${theme === 'dark' ? 'text-white' : 'text-black'}`}
        >
          {getTranslatedTemplateName() ||
            t('templateCard.defaultTitle', {
              platform: category === 'google' ? 'Google Ads' : 'Meta Ads',
            })}
        </CardTitle>
        <CardDescription
